...
const LoginPage = () => {
  ...
  return (
    <Layout title="Login - SecureAuth Pro">
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <motion.div variants={itemVariants} className="flex items-center justify-between">
                  <label className="flex items-center space-x-2">
                    <input
                      type="checkbox"
                      className="w-5 h-5 rounded border-dark-600 bg-dark-800 text-neon-blue focus:ring-neon-blue focus:ring-offset-0"
                    />
            ...
            <motion.div variants={itemVariants} className="my-8">
              ...
              <motion.div variants={itemVariants} className="space-y-4">
                <motion.button
                  ...
                  disabled={isLoading}
                  className="btn-secondary w-full flex items-center justify-center space-x-3 py-4 text-lg border-2 border-dark-600 hover:border-neon-blue bg-dark-800/50 backdrop-blur-sm"
                ...
                <motion.button
                  ...
                  disabled={isLoading}
                  className="btn-secondary w-full flex items-center justify-center space-x-3 py-4 text-lg border-2 border-dark-600 hover:border-neon-purple bg-dark-800/50 backdrop-blur-sm"
